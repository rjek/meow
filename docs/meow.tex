...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    instructions.  It feature a simple memory map, basic multi-processing,
    ...
    such that it is easy to fit in small, hobbyest, cheap FPGAs, as the
  ...
  \chapter{Registers}
    MEOW uses 4 bits to describe registers, and thus has 16 available.
    Additionally, it has two banks of these 16 registers, and swaps between
    them when entering interrupt mode, such that it can have its own stack,
    and other environmental values untouched by the program executing.
  ...
  \chapter{Instructions}
    ...
    \section{Addition -- ADD}
      \subsection*{Add two registers and a 4 bit immediate}
        \begin{center}
      ...
      \subsection*{Add register and an 8 bit immediate}
        \begin{center}
    ...
    \section{Subtraction -- SUB}
      \subsection*{Subtracts two registers and a 4 bit immediate}
        \begin{center}
      ...
      \subsection*{Subtracts register and an 8 bit immediate}
        \begin{center}
